...
|--------|-------------|-------------|
| **Hot-loading** | ✅ Provides infrastructure | ✅ Decides what to load |
| **Tool execution** | ✅ Sandboxed runtime | ✅ Defines tool logic |
| **Code generation** | ❌ Not implemented | Application decision |
| **Extension strategy** | ❌ Not implemented | Application decision |
